    ...
    <View style={style.container}>
      ...
      >
        <View>
          ...
          <Button
            mode="contained"
            onPress={addSteps} /*TODO integrate icon_add-steps.png */
          >
            Add my steps
          </Button>
          ...
          <Button
            ...
            onPress={
              fakeSteps
            } /*TODO remove this button once stepcount for android is implemented */
          >
            Fake some steps
          </Button>
        </View>
        <View>
          <Text /*TODO sry for that, quick fix to space the elements out*/>
            {" "}
          </Text>
        </View>
        <View>
